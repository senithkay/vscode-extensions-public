...
function convertQueryParamStringToSegments(arg0: string): QueryParamCollection {
    throw new Error("Function not implemented.");
}

function recalculateItemIds(queryParams: import("../types").QueryParam[]) {
    throw new Error("Function not implemented.");
}

function generateQueryParamFromQueryCollection(queryParamCollectionClone: QueryParamCollection): string {
    throw new Error("Function not implemented.");
}
