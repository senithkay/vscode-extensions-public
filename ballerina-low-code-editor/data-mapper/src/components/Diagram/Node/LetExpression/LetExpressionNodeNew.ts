...
export const LET_EXPR_SOURCE_NODE_TYPE_NEW = "datamapper-node-type-desc-let-expression-new";
...
export class LetExpressionNodeNew extends DataMapperNodeModel {
