...
export const INIT_INCLUSIVE_RECORD_CONSTRUCTOR = "TYPE_DESCRIPTOR EXPRESSION;}"
export const APPEND_INCLUSIVE_RECORD_CONSTRUCTOR = "TYPE_DESCRIPTOR EXPRESSION;}"
export const INIT_EXCLUSIVE_RECORD_CONSTRUCTOR = "TYPE_DESCRIPTOR EXPRESSION;|}"
export const APPEND_EXCLUSIVE_RECORD_CONSTRUCTOR = "TYPE_DESCRIPTOR EXPRESSION;|}"
