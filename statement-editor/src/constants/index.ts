...
export const INIT_TYPE_DESC_CONSTRUCTOR = "TYPE_DESCRIPTOR]"
export const APPEND_TYPE_DESC_CONSTRUCTOR = ", TYPE_DESCRIPTOR]"
export const INIT_FIELD_CONSTRUCTOR = "EXPRESSION)"
export const APPEND_FIELD_CONSTRUCTOR = ", EXPRESSION)"
export const INIT_INCLUSIVE_RECORD_CONSTRUCTOR = "TYPE_DESCRIPTOR BINDING_PATTERN;}"
export const APPEND_INCLUSIVE_RECORD_CONSTRUCTOR = "TYPE_DESCRIPTOR BINDING_PATTERN;}"
export const INIT_EXCLUSIVE_RECORD_CONSTRUCTOR = "TYPE_DESCRIPTOR BINDING_PATTERN;|}"
export const APPEND_EXCLUSIVE_RECORD_CONSTRUCTOR = "TYPE_DESCRIPTOR BINDING_PATTERN;|}"
