...
export const MODULE_VAR_ACCESS_MODIFIER_CONSTRUCTOR = "ACCESS_MODIFIER"
export const CONSTANT_NAME_CONSTRUCTOR = 'CONST_NAME'
...
export const PLACEHOLDER_DIAGNOSTICS: string[] = [
    ...
    DEFAULT_INTERMEDIATE_CLAUSE_PLACEHOLDER, CONSTANT_NAME_CONSTRUCTOR
];
