...
export { OperatorComponent as AsteriskToken };
export { OperatorComponent as BitwiseAndToken };
export { OperatorComponent as BitwiseXorToken };
...
export { OperatorComponent as LogicalOrToken };
export { OperatorComponent as LtEqualToken };
export { OperatorComponent as LtToken };
export { OperatorComponent as MinusToken };
export { OperatorComponent as NotDoubleEqualToken };
export { OperatorComponent as NotEqualToken };
export { OperatorComponent as PercentToken };
export { OperatorComponent as PipeToken };
export { OperatorComponent as PlusToken };
export { OperatorComponent as SlashToken };
export { OperatorComponent as TrippleEqualToken };
export { OperatorComponent as DoubleGtToken };
export { OperatorComponent as DoubleLtToken };
export { OperatorComponent as TrippleGtToken };
