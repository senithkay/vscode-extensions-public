...
import { AsteriskTokenComponent } from './Operator/AsteriskToken';
import { BitwiseAndTokenComponent } from './Operator/BitwiseAndToken';
import { BitwiseXorTokenComponent } from './Operator/BitwiseXorToken';
import { DoubleDotLtTokenComponent } from './Operator/DoubleDotLtToken';
import { DoubleEqualTokenComponent } from './Operator/DoubleEqualToken';
import { EllipsisTokenComponent } from './Operator/EllipsisToken';
import { GtEqualTokenComponent } from './Operator/GtEqualToken';
import { GtTokenComponent } from './Operator/GtToken';
import { LogicalAndTokenComponent } from './Operator/LogicalAndToken';
import { LogicalOrTokenComponent } from './Operator/LogicalOrToken';
import { LtEqualTokenComponent } from './Operator/LtEqualToken';
import { LtTokenComponent } from './Operator/LtToken';
import { MinusTokenComponent } from './Operator/MinusToken';
import { NotDoubleEqualTokenComponent } from './Operator/NotDoubleEqualToken';
import { NotEqualTokenComponent } from './Operator/NotEqualToken';
import { PercentTokenComponent } from './Operator/PercentToken';
import { PlusTokenComponent } from './Operator/PlusToken';
import { SlashTokenComponent } from './Operator/SlashToken';
import { TrippleEqualTokenComponent } from './Operator/TrippleEqualToken';
...
export { AsteriskTokenComponent as AsteriskToken };
export { BitwiseAndTokenComponent as BitwiseAndToken };
export { BitwiseXorTokenComponent as BitwiseXorToken };
export { DoubleDotLtTokenComponent as DoubleDotLtToken };
export { DoubleEqualTokenComponent as DoubleEqualToken };
export { EllipsisTokenComponent as EllipsisToken };
export { GtEqualTokenComponent as GtEqualToken };
export { GtTokenComponent as GtToken };
export { LogicalAndTokenComponent as LogicalAndToken };
export { LogicalOrTokenComponent as LogicalOrToken };
export { LtEqualTokenComponent as LtEqualToken };
export { LtTokenComponent as LtToken };
export { MinusTokenComponent as MinusToken };
export { NotDoubleEqualTokenComponent as NotDoubleEqualToken };
export { NotEqualTokenComponent as NotEqualToken };
export { PercentTokenComponent as PercentToken };
export { PlusTokenComponent as PlusToken };
export { SlashTokenComponent as SlashToken };
export { TrippleEqualTokenComponent as TrippleEqualToken };
