...
export default function ToolbarDeleteIcon(){
    return(
        <svg width="14px" height="14px" viewBox="0 0 14 14" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            ...
            <g id="Tree-Editor" stroke="none" stroke-width="1" fill="currentColor" fill-rule="evenodd">
                <g id="SE-f9-suggestions" transform="translate(-1385.000000, -277.000000)">
                    <g id="Icon/Delete" transform="translate(1385.500000, 277.000000)">
                        <mask id="mask-2" fill="white">
                            <use xlinkHref="#path-1"/>
                        </mask>
                        <use id="Combined-Shape" fill="currentColor" fill-rule="nonzero" xlinkHref="#path-1"/>
                    </g>
                </g>
            </g>
        </svg>
