...
export const ChoreoIcon = (props: SVGProps<SVGSVGElement> & { color?: string }) => {
	const { color = "var(--vscode-foreground)", ...rest } = props;

	return (
		<svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" height="16" width="16" viewBox="0 0 96 96" {...rest}>
			<path
