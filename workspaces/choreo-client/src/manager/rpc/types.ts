 ...
 *  associated services.
 */
import { ChoreoComponentCreationParams, IsRepoClonedRequestParams, Location, Project, RepoCloneRequestParams } from "@wso2-enterprise/choreo-core";
...
export const DeleteComponent: RequestType<Location, boolean> = { method: 'manager/deleteComponent' };
