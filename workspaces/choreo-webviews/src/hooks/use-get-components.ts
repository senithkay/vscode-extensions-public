...
export function useGetComponents() {
    ...
    const {
        ...
        enabled: isChoreoProject && choreoProject !== undefined,
        keepPreviousData: true
    });

    return { components, isLoadingComponents, isRefetchingComponents, refreshComponents, componentLoadError, isFetched };
}
