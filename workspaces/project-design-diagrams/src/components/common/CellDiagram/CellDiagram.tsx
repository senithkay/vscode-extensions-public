...
export function CellDiagram(props: CellDiagramProps) {
    ...
    const [isConsoleRendered, setIsConsoleRendered] = useState(consoleView === undefined);
    ...
    return (
        <CellDiagramWrapper isConsoleView={consoleView}>
            <CellContainerWrapper consoleView={consoleView}>
                ...
                <CellContainer path={borderPath} vertices={vertices} isConsoleRendered={isConsoleRendered}>
