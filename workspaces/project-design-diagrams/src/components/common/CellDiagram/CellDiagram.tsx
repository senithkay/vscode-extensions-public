...
export function CellDiagram(props: CellDiagramProps) {
    ...
    useEffect(() => {
        // This is to capture width and height of the screen on window resize
        const handleResize = () => {
    ...
    const innerBorderPath = `path("M ${vertices[0].x + 9} ${vertices[0].y + 1} L ${vertices[1].x - 9} ${vertices[1].y + 1} C ${vertices[1].x - 3} ${vertices[1].y + 2} ${vertices[1].x + 1} ${vertices[1].y + 3} ${vertices[1].x + 7} ${vertices[1].y + 8} L ${vertices[2].x - 7} ${vertices[2].y - 5} C ${vertices[2].x - 6} ${vertices[2].y - 2} ${vertices[2].x - 1} ${vertices[2].y + 1} ${vertices[2].x - 1} ${vertices[2].y + 8} L ${vertices[3].x - 1} ${vertices[3].y + 74} C ${vertices[3].x - 1} ${vertices[3].y + 79} ${vertices[3].x - 3} ${vertices[3].y + 85} ${vertices[3].x - 7} ${vertices[3].y + 90} L ${vertices[4].x + 8} ${vertices[4].y + 77} C ${vertices[4].x + 6} ${vertices[4].y + 78} ${vertices[4].x + 7} ${vertices[4].y + 80} ${vertices[4].x - 1} ${vertices[4].y + 84} L ${vertices[5].x + 9} ${vertices[5].y + 83} C ${vertices[5].x + 1} ${vertices[5].y + 83} ${vertices[5].x - 5} ${vertices[5].y + 79}  ${vertices[5].x - 8} ${vertices[5].y + 75}  L ${vertices[6].x + 6} ${vertices[6].y + 90} C ${vertices[6].x + 2} ${vertices[6].y + 81} ${vertices[6].x} ${vertices[6].y + 64} ${vertices[6].x + 1} ${vertices[6].y + 63} L ${vertices[7].x + 1} ${vertices[7].y + 8} C ${vertices[7].x + 1} ${vertices[7].y + 1} ${vertices[7].x + 5} ${vertices[7].y - 3} ${vertices[7].x + 8} ${vertices[7].y - 6} L ${vertices[0].x - 6} ${vertices[0].y + 6} C ${vertices[0].x - 5} ${vertices[0].y + 5} ${vertices[0].x - 1} ${vertices[0].y + 1} ${vertices[0].x + 9} ${vertices[0].y + 1} Z")`;
    const borderPath = `path("M ${vertices[0].x + 10} ${vertices[0].y} L ${vertices[1].x - 10} ${vertices[1].y} C ${vertices[1].x - 5} ${vertices[1].y} ${vertices[1].x + 3} ${vertices[1].y + 3} ${vertices[1].x + 7} ${vertices[1].y + 7} L ${vertices[2].x - 8} ${vertices[2].y - 7} C ${vertices[2].x - 4} ${vertices[2].y - 3} ${vertices[2].x} ${vertices[2].y + 4} ${vertices[2].x} ${vertices[2].y + 10} L ${vertices[3].x} ${vertices[3].y + 75} C ${vertices[3].x} ${vertices[3].y + 80} ${vertices[3].x - 4} ${vertices[3].y + 88} ${vertices[3].x - 7} ${vertices[3].y + 91} L ${vertices[4].x + 4} ${vertices[4].y + 82} C ${vertices[4].x + 6} ${vertices[4].y + 77} ${vertices[4].x + 8} ${vertices[4].y + 81} ${vertices[4].x - 2} ${vertices[4].y + 85} L ${vertices[5].x + 10} ${vertices[5].y + 84} C ${vertices[5].x + 4} ${vertices[5].y + 84} ${vertices[5].x - 4} ${vertices[5].y + 81}  ${vertices[5].x - 7} ${vertices[5].y + 77}  L ${vertices[6].x + 7} ${vertices[6].y + 92} C ${vertices[6].x + 2} ${vertices[6].y + 88} ${vertices[6].x} ${vertices[6].y + 66} ${vertices[6].x} ${vertices[6].y + 65} L ${vertices[7].x} ${vertices[7].y + 10} C ${vertices[7].x} ${vertices[7].y + 4} ${vertices[7].x + 3} ${vertices[7].y - 4} ${vertices[7].x + 7} ${vertices[7].y - 6} L ${vertices[0].x - 7} ${vertices[0].y + 6} C ${vertices[0].x - 3} ${vertices[0].y + 1} ${vertices[0].x - 4} ${vertices[0].y + 4} ${vertices[0].x + 3} ${vertices[0].y} Z")`;
    return (
        <CellDiagramWrapper isConsoleView={consoleView}>
            <CellContainerWrapper consoleView={consoleView}>
                ...
                {/* This is the Octagonal shaped div  which has the outer path */}
                <CellContainer path={borderPath} vertices={vertices}>
                    {/* This is the Octagonal shaped div  which has the inner path */}
                    <CanvasWrapper id={"cell-canvas-wrapper"} path={innerBorderPath} vertices={vertices}>
                        <DiagramCanvasWidget
