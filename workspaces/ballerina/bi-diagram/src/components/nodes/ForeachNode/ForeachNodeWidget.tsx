...
interface ForeachNodeWidgetProps {
    model: ForeachNodeModel;
    engine: DiagramEngine;
    onClick?: (node: FlowNode) => void;
}

export interface NodeWidgetProps extends Omit<ForeachNodeWidgetProps, "children"> { }

export function ForeachNodeWidget(props: ForeachNodeWidgetProps) {
