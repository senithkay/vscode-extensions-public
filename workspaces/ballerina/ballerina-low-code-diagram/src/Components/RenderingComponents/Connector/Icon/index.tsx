...
import { DefaultConnectorIcon } from "./DefaultConnectorIcon";
...
export { ZoomLogo as zoom_Client};
export { MediumLogo as medium_Client};
export { BitbucketLogo as bitbucket_Client};
export { SpotifyLogo as spotify_Client};
export { SendGridLogo as sendgrid_Client};
...
export { DefaultConnectorIcon as defaultIcon };
