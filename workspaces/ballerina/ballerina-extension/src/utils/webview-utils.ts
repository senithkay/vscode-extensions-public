...
export function getLibraryWebViewContent(options: WebViewOptions, webView: Webview, background: string ="#fff", padding: string="0px"): string {
    ...
    const fontsUri = webView.asWebviewUri(Uri.joinPath((ballerinaExtInstance.context as ExtensionContext).extensionUri, "resources", "font-wso2-vscode", "dist", "wso2-vscode.css"));
