...
export const UPDATE_BALLERINA_VERSION: string = "Your Ballerina version does not contain latest language server features. Please update Ballerina version to Update 12 or later.";
