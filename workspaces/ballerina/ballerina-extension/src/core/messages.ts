...
export const UPDATE_BALLERINA_VERSION_TO_LATEST: string = "A new Ballerina version is available. Please update Ballerina version to experience the latest features.";
