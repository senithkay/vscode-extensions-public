  ...
  return (
    <Overlay>
      <DialogContainer>
        ...
        <Text>
          Select a feedback option below, or add a comment:
        </Text>
        ...
        {(!isPositive) && (
          <Notice>
            By submitting, your feedback and the current conversation will be securely shared with WSO2 to help us improve your experience.
          </Notice>
        )}
        <ButtonContainer>
