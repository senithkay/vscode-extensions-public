...
export function EntryPointConfigForm(props: ConfigProps) {
        ...
        <Container>
            {formFields &&
                <>
                    {formFields.length > 0 &&
                        <FormContainer>
                            <FormHeader title={`Select Entry Point`} subtitle={`Choose an integration to initiate the AI Agent's workflow`} />
                            {filePath &&
                                <FormGeneratorNew
                                    fileName={filePath}
...
export default EntryPointConfigForm;
