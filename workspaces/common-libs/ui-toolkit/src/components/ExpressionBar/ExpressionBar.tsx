...
export type ExpressionBarBaseProps = {
    ...
    // - The function to be called when ctrl + key pressed. Should return true to prevent default key press behavior
    onShortcut?: (e: React.KeyboardEvent) => Promise<boolean>;
