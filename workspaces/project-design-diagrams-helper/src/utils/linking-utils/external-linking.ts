...
import { runBackgroundTerminalCommand } from "../../commands";
...
export async function addConnector(langClient: any, args: AddConnectorArgs): Promise<boolean> {
...
export async function pullConnector(langClient: any, args: AddConnectorArgs): Promise<boolean> {
    const { source, connector } = args;
    const filePath: string = source.elementLocation.filePath;
    const stResponse = (await langClient.getSyntaxTree({
        documentIdentifier: {
...
async function linkFromService(stResponse: STResponse, source: Service, imports: Set<string>, connectorInfo: BallerinaConnectorInfo,
    filePath: string, langClient: any): Promise<boolean> {
...
async function linkFromMain(stResponse: STResponse, connector: BallerinaConnectorInfo, imports: Set<string>, filePath: string,
    langClient: any): Promise<boolean> {
...
async function fetchConnectorInfo(connector: Connector, langClient: any): Promise<BallerinaConnectorInfo | undefined> {
