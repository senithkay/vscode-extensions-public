...
import { getChoreoExtAPI } from "../../choreo-ext";
import { deleteBallerinaPackage, deleteComponentOnly } from "../component-utils";

const ballerinaToml = "Ballerina.toml";

export function getComponentModel(langClient: any, isChoreoProject: boolean): Promise<GetComponentModelResponse> {
...
export async function updateSourceFile(langClient: any, filePath: string, fileContent: string): Promise<boolean> {
