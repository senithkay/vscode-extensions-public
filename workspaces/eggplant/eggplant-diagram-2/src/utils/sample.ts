...
export function sampleDiagram(model: any, diagramModel: DiagramModel, engine: DiagramEngine) {
    var mediatorList = (model as any).inSequence.mediatorList;
    ...
    // create nodes
    var nodestart = new StartNodeModel((model as any).inSequence);
