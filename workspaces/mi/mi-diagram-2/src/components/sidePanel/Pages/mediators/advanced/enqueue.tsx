...
const EnqueueForm = (props: AddMediatorProps) => {
    ...
    const onClick = async () => {
        ...
        if (Object.keys(newErrors).length > 0) {
            ...
            const xml = getXML(MEDIATORS.ENQUEUE, formValues);
    ...
    const formValidators: { [key: string]: (e?: any) => string | undefined } = {
        "executor": (e?: any) => validateField("executor", e, false),
        "priority": (e?: any) => validateField("priority", e, false, "integer"),
        "sequenceKey": (e?: any) => validateField("sequenceKey", e, false),
        "description": (e?: any) => validateField("description", e, false),

    };

    const validateField = (id: string, e: any, isRequired: boolean, validation?: "e-mail" | "nameWithoutSpecialCharactors" | "integer" | "custom", regex?: string): string => {
        ...
        if (isRequired && !value) {
            ...
            error = "Invalid name";
        } else if (validation === "integer" && !value.match(integerRegex)) {
            error = "Invalid input";
        }
            ...
            <ComponentCard sx={cardStyle} disbaleHoverEffect>
                ...
                <Field>
                    <TextField
                        ...
                        required={false}
                    />
                    {errors["executor"] && <Error>{errors["executor"]}</Error>}
                </Field>
