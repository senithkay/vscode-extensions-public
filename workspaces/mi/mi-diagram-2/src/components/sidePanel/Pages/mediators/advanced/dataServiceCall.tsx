...
const DataServiceForm = (props: AddMediatorProps) => {
    ...
    const [dataServices, setDataServices] = useState([] as string[]);
    ...
    const fetchAvailableResources = async () => {
        // TODO: fetch available dataservices
    }
    ...
    const onClick = async () => {
        ...
        if (Object.keys(newErrors).length > 0) {
            ...
            const xml = getXML(MEDIATORS.DATASERVICECALL, formValues);
    ...
    return (
        <div style={{ padding: "10px" }}>
            ...
            <ComponentCard sx={cardStyle} disbaleHoverEffect>
                    ...
                    <TextField
                        ...
                        onChange={(e: any) => {
                            ...
                            if (dataServices.includes(e)) {
                                ...
                                updateValues["availableDataServices"] = "Select from available Data Services";
                            }
                ...
                {formValues["sourceType"] && formValues["sourceType"] == "INLINE" && (<ComponentCard sx={cardStyle} disbaleHoverEffect>
                    <h3>Operations</h3>
                    ...
                    <ComponentCard sx={cardStyle} disbaleHoverEffect>
                        ...
                        <div style={{ textAlign: "right", marginTop: "10px" }}>
                            <Button appearance="primary" onClick={() => {
                                const isExpression = formValues["propertyValueType"] == "EXPRESSION";
                                if (!(validateField("propertyName", formValues["propertyName"], true) || validateField("propertyValue", formValues["propertyValue"], !isExpression) || validateField("propertyValue", formValues["propertyExpression"], isExpression))) {
                                    setFormValues({
                                        ...formValues, "propertyName": undefined, "propertyValue": undefined,
                                        "DSSProperties": [...formValues["DSSProperties"], [formValues["propertyName"], formValues["propertyValueType"], formValues["propertyValue"] ?? formValues["propertyExpression"]]]
                                    });
                                }
                            }}>
                                Add
                    ...
                    <div style={{ textAlign: "right", marginTop: "10px" }}>
                        <Button appearance="primary" onClick={() => {
                            if (!(validateField("operationName", formValues["operationName"], true))) {
                                setFormValues({
                                    ...formValues, "operationName": undefined, "": undefined,
                                    "operations": [...formValues["operations"], [formValues["operationName"], formValues["DSSProperties"]]]
                                });
                            }
                        }}>
                            Add
