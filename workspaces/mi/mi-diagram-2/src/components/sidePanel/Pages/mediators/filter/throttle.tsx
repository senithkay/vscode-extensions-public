...
const ThrottleForm = (props: AddMediatorProps) => {
    ...
    const onClick = async (values: any) => {
        ...
        const xml = getXML(MEDIATORS.THROTTLE, values);
            ...
            <ComponentCard sx={cardStyle} disbaleHoverEffect>
                ...
                <Field>
                    <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                            <AutoComplete label="On Accept Branchsequence Type" items={["ANONYMOUS", "REGISTRY_REFERENCE"]} value={field.value} onValueChange={(e: any) => {
                                field.onChange(e);
                            }} />
                        )}
                    />
            ...
            <ComponentCard sx={cardStyle} disbaleHoverEffect>
                ...
                <Field>
                    <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                            <AutoComplete label="On Reject Branchsequence Type" items={["ANONYMOUS", "REGISTRY_REFERENCE"]} value={field.value} onValueChange={(e: any) => {
                                field.onChange(e);
                            }} />
                        )}
                    />
            ...
            <ComponentCard sx={cardStyle} disbaleHoverEffect>
                ...
                <Field>
                    <Controller
                        ...
                        control={control}
                        render={({ field }) => (
                            <AutoComplete label="Policy Type" items={["INLINE", "REGISTRY_REFERENCE"]} value={field.value} onValueChange={(e: any) => {
                                field.onChange(e);
                            }} />
                        )}
                    />
