...
import { ProjectStructureRequest, ProjectStructureResponse, WorkspacesResponse, OpenViewRequest, HistoryEntryResponse, ToggleDisplayOverviewRequest, GetAllRegistryPathsResponse, GetAllRegistryPathsRequest, GoToSourceRequest, GoToSourceRequest } from "./types";
