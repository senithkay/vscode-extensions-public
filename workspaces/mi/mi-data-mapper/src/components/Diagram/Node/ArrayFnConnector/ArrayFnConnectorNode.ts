...
export class ArrayFnConnectorNode extends DataMapperNodeModel {
    ...
    private findTargetPort(): void {
        ...
        const fieldName = (Node.isPropertyAssignment(innerMostExpr) && innerMostExpr.getNameNode()) || (Node.isElementAccessExpression(innerMostExpr) && (innerMostExpr.getParent() as PropertyAssignment)?.getNameNode());
