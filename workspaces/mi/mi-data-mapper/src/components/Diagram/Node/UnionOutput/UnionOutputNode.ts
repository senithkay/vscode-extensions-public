...
export const UNION_OUTPUT_NODE_TYPE = "data-mapper-node-union-output";
const NODE_ID = "union-output-node";

export class UnionOutputNode extends DataMapperNodeModel {
