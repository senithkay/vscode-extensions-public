...
export function Overview(props: OverviewProps) {
    ...
    const goToDevant = () => {
        rpcClient.getMiDiagramRpcClient().executeCommand({commands: [PlatformExtCommandIds.OpenInConsole, {extensionName:"Devant",componentFsPath: activeWorkspaces.fsPath} as IOpenInConsoleCmdParams]})
    };
