...
export const useIOTypes = (filePath: string, functionName: string, interfacesSource: string, fileContent: string) => {
    ...
    const {
        ...
        refetch
    } = useQuery(['getIOTypes', { filePath, functionName, interfacesSource, fileContent }], () => getIOTypes(), {});
