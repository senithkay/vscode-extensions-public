...
//         console.log("Launching language client");
//         try {
...
//                 let schemaPath = path.join("../", "../", "../", "../", "../", "mi-extension", "synapse-schemas", "synapse_config.xsd");
//                 // let langServerCP = this.context.asAbsolutePath(path.join('ls', '*'));     // Folder path for jars           
//                 let langServerCP = path.join("../", "../", "../", "../", "../", "mi-extension", "ls", "synapse_config.xsd");          
