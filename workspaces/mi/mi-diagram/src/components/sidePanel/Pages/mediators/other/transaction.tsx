...
const TransactionForm = (props: AddMediatorProps) => {
    ...
    return (
        <>
            <Typography sx={{ padding: "10px 20px", borderBottom: "1px solid var(--vscode-editorWidget-border)" }} variant="body3">Provides transaction management for child mediators.</Typography>
