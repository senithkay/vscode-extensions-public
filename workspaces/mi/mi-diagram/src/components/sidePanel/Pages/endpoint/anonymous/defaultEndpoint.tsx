...
import { getDefaultEndpointMustacheTemplate } from "../../../../../utils/template-engine/mustach-templates/endpoints/default";
...
const DefaultEndpointForm = (props: AddMediatorProps) => {
    ...
    const onClick = async () => {
        ...
        if (Object.keys(newErrors).length > 0) {
            ...
            const template = getDefaultEndpointMustacheTemplate();
...
export default DefaultEndpointForm; 
