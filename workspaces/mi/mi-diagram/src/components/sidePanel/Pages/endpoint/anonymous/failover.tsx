...
import { getFailoverEndpointMustacheTemplate } from "../../../../../utils/template-engine/mustach-templates/endpoints/failover";
...
const FailoverEndpointForm = (props: AddMediatorProps) => {
    ...
    const onClick = async () => {
        ...
        if (Object.keys(newErrors).length > 0) {
            ...
            const template = getFailoverEndpointMustacheTemplate();
