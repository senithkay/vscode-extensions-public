...
import { getLoadBalanceEndpointMustacheTemplate } from "../../../../../utils/template-engine/mustach-templates/endpoints/loadbalance";
...
const LoadbalanceEndpointForm = (props: AddMediatorProps) => {
    ...
    const onClick = async () => {
        ...
        if (Object.keys(newErrors).length > 0) {
            ...
            const template = getLoadBalanceEndpointMustacheTemplate();
