...
import { TRIGGER_RECT_SVG_HEIGHT, TRIGGER_RECT_SVG_WIDTH } from "../components/LowCodeDiagram/ActionInvocation/TriggerSVG";
import { ASSIGNMENT_NAME_WIDTH } from "../components/LowCodeDiagram/Assignment";
import { COLLAPSE_SVG_HEIGHT_WITH_SHADOW, COLLAPSE_SVG_WIDTH_WITH_SHADOW } from "../components/LowCodeDiagram/Collapse/CollapseSVG";
import { CLIENT_RADIUS, CLIENT_SVG_HEIGHT, CLIENT_SVG_WIDTH } from "../components/LowCodeDiagram/Connector/ConnectorHeader/ConnectorClientSVG";
import { EXISTING_PLUS_HOLDER_API_HEIGHT, EXISTING_PLUS_HOLDER_API_HEIGHT_COLLAPSED, PLUS_HOLDER_API_HEIGHT, PLUS_HOLDER_API_HEIGHT_COLLAPSED, PLUS_HOLDER_STATEMENT_HEIGHT, PLUS_HOLDER_WIDTH } from "../components/LowCodeDiagram/DialogBoxes/PlusHolder/PlusElements";
import { STOP_SVG_HEIGHT, STOP_SVG_WIDTH } from "../components/LowCodeDiagram/End/StopSVG";
import { FOREACH_SVG_HEIGHT, FOREACH_SVG_WIDTH } from "../components/LowCodeDiagram/ForEach/ForeachSVG";
import { COLLAPSE_DOTS_SVG_HEIGHT } from "../components/LowCodeDiagram/ForEach/ThreeDotsSVG";
import { IFELSE_SVG_HEIGHT, IFELSE_SVG_WIDTH } from "../components/LowCodeDiagram/IfElse/IfElseSVG";
import { LISTENER_HEIGHT, LISTENER_WIDTH } from "../components/LowCodeDiagram/Listener/ListenerSVG";
import { MIN_MODULE_VAR_WIDTH, MODULE_VAR_HEIGHT } from "../components/LowCodeDiagram/ModuleVariable";
import { PLUS_SVG_HEIGHT, PLUS_SVG_WIDTH } from "../components/LowCodeDiagram/Plus/PlusAndCollapse/PlusSVG";
import { PROCESS_SVG_HEIGHT, PROCESS_SVG_WIDTH, PROCESS_SVG_WIDTH_WITH_HOVER_SHADOW } from "../components/LowCodeDiagram/Processor/ProcessSVG";
import { RESPOND_SVG_HEIGHT, RESPOND_SVG_WIDTH } from "../components/LowCodeDiagram/Respond/RespondSVG";
import { DEFAULT_SERVICE_WIDTH } from "../components/LowCodeDiagram/Service";
import { SERVICE_HEADER_HEIGHT } from "../components/LowCodeDiagram/Service/ServiceHeader";
import { START_SVG_HEIGHT, START_SVG_WIDTH } from "../components/LowCodeDiagram/Start/StartSVG";
import { VARIABLE_NAME_WIDTH } from "../components/LowCodeDiagram/VariableName";
import { WHILE_SVG_HEIGHT, WHILE_SVG_WIDTH } from "../components/LowCodeDiagram/While/WhileSVG";
