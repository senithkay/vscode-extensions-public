...
// 2066 = Incompatible types, 0411 = Missing quotes, 2010 = Undefined symbol, 0012 = Missing plus token
export const INCORRECT_STR_DIAGNOSTICS = ["BCE2066", "BCE0411", "BCE2010", "BCE0012"]
