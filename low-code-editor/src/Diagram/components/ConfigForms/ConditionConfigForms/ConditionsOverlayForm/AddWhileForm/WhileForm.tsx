...
export interface WhileFormProps {
    statementEditor: JSX.Element;
    expressionEditor: JSX.Element;
}

export function WhileForm(props: WhileFormProps) {
    const {statementEditor, expressionEditor} = props;
