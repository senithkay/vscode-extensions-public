...
export function OperationDropdown(props: OperationDropdownProps) {
    ...
    const operationDropdownPlaceholder = intl.formatMessage({
        id: "lowcode.develop.connectorForms.GCalendar.operationDropdown.placeholder",
        ...
        <div>
            <div className={classNames(classes.configWizardAPIContainerAuto, classes.bottomRadius)}>
                <div className={classes.fullWidth}>
                    { showConnectionName && (
                        <>
                            <p className={classes.subTitle}><FormattedMessage id="lowcode.develop.connectorForms.operationDropdown.GCalendar.connectionName.title" defaultMessage="Connection"/></p>
                    ...
                    <p className={classes.subTitle}><FormattedMessage id="lowcode.develop.connectorForms.GCalendar.operationDropdown.title" defaultMessage="Operation"/></p>
                    <FormAutocomplete
