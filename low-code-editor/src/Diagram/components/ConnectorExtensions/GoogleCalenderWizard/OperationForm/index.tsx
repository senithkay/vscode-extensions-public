...
export function OperationForm(props: OperationFormProps) {
    ...
    const responseVariableInstructionsBullet1 = intl.formatMessage({
        id: "lowcode.develop.connectorForms.GCalendar.responseVariableNametooltip.instructions.bulletPoint1",
        defaultMessage: "include spaces and special characters"
      });

    const responseVariableInstructionsBullet2 = intl.formatMessage({
        id: "lowcode.develop.connectorForms.GCalendar.responseVariableNametooltip.instructions.bulletPoint2",
        defaultMessage: "start with a numerical character"
      });

    const responseVariableInstructionsBullet3 = intl.formatMessage({
        id: "lowcode.develop.connectorForms.GCalendar.responseVariableNametooltip.instructions.bulletPoint3",
    ...
    const responseVariableInstructions = intl.formatMessage({
        id: "lowcode.develop.connectorForms.GCalendar.responseVariableNametooltip.instructions.title",
