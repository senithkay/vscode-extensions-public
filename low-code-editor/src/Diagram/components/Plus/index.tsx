...
import { PlusElements } from "../Portals/Overlay/Elements/PlusHolder";
...
import { PlusAndCollapseSVG } from "./PlusAndCollapse";
import "./style.scss";
...
export const PlusButton = (props: PlusProps) => {
    ...
    const handlePlusHolderItemClick = (type: string, subType: string,
                                       connectorType: BallerinaConnectorsInfo = undefined, selectedConnector: LocalVarDecl = undefined) => {
        setStates({
            isPlusHolderShown: false,
            isSmallPlusShown: false,
            isCollapsePlusDuoShown: false
