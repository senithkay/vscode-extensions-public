    ...
    return (
        <svg transform={scale ? `scale(${scale})` : ''} x={!cx ? 0 : cx - (HTTP_LOGO_WIDTH / 2)} y={!cy ? 0 : cy - (HTTP_LOGO_HEIGHT / 2)} width={HTTP_LOGO_WIDTH} height={HTTP_LOGO_HEIGHT} >
            <g id="HttpWrapper" transform="translate(1 1)">
                ...
                <path id="Path" d="M0,.5H18.333" transform="translate(0.833 0.542)" fill="none" stroke="#ccd1f2" strokeLinecap="round" stroke-miterlimit="10" strokeWidth="3.175" />
                <path id="Path-2" d="M18.333.5H0" transform="translate(0.833 18.458)" fill="none" stroke="#ccd1f2" strokeLinecap="round" stroke-miterlimit="10" strokeWidth="3.175" />
            </g>
        </svg>
    )
}
