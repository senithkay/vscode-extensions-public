    ...
    return (
        <svg transform={scale ? `scale(${scale})` : ''} x={!cx ? 0 : cx - (IMAP_LOGO_WIDTH / 2)} y={!cy ? 0 : cy - (IMAP_LOGO_HEIGHT / 2)} width={IMAP_LOGO_WIDTH} height={IMAP_LOGO_HEIGHT} >
            <g id="Logo_IMAP" transform="translate(-88.089 -354.061)">
                <path id="Path" d="M89.676,355.648h18.333" fill="none" stroke="#ccd1f2" stroke-linecap="round" stroke-miterlimit="10" stroke-width="3.175" />
                <path id="Path-2" d="M108.009,373.564H89.676" fill="none" stroke="#ccd1f2" stroke-linecap="round" stroke-miterlimit="10" stroke-width="3.175" />
