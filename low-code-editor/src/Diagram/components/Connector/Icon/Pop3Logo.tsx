    ...
    return (
        <svg transform={scale ? `scale(${scale})` : ''} x={!cx ? 0 : cx - (POP3_LOGO_WIDTH / 2)} y={!cy ? 0 : cy - (POP3_LOGO_HEIGHT / 2)} width={POP3_LOGO_WIDTH} height={POP3_LOGO_HEIGHT} >
            <g id="Pop3Wrapper" transform="translate(1 1)">
                ...
                <path id="Path" d="M0,.5H18.333" transform="translate(0.833 0.542)" fill="none" stroke="#ccd1f2" stroke-linecap="round" stroke-miterlimit="10" stroke-width="3.175" />
                <path id="Path-2" d="M18.333.5H0" transform="translate(0.833 18.458)" fill="none" stroke="#ccd1f2" stroke-linecap="round" stroke-miterlimit="10" stroke-width="3.175" />
            </g>
        </svg>
    )
}
