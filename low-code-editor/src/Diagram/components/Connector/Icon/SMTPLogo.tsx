    ...
    return (
        <svg transform={scale ? `scale(${scale})` : ''} x={!cx ? 0 : cx - (SMTP_LOGO_WIDTH / 2)} y={!cy ? 0 : cy - (SMTP_LOGO_HEIGHT / 2)} width={SMTP_LOGO_WIDTH} height={SMTP_LOGO_HEIGHT} >
            <g id="SmtpLogo" transform="translate(-54.5 -352)">
                <path id="Path" d="M56.47,354.159H74.8" fill="none" stroke="#ccd1f2" stroke-linecap="round" stroke-miterlimit="10" stroke-width="3.175" />
                <path id="Path-2" d="M74.8,372.075H56.47" fill="none" stroke="#ccd1f2" stroke-linecap="round" stroke-miterlimit="10" stroke-width="3.175" />
                <g id="Group_9">
