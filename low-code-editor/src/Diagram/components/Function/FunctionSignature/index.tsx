    ...
    if (STKindChecker.isResourceAccessorDefinition(model)) {
        ...
        component.push((
            ...
            >
                ...
                <div style={{ width: 40 }} onClick={onExpandClick}>
                    {
                        isExpanded ?
                            (
                                <svg style={{ marginLeft: 20, marginTop: 20 }}  width="12px" height="7px" viewBox="0 0 12 7" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                            ...
                            (
                                <svg style={{ marginLeft: 20, marginTop: 20 }} width="7px" height="12px" viewBox="0 0 7 12" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                    <g id="Home" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
