...
export function ObjectTypeDraftButton(props: ObjectTypeDraftButtonProps) {
	...
	return (
		<svg id={'add-json-object-field-btn'} {...xyProps} onClick={onClick} className={'json-add-field-btn'} width="14px" height="16px" viewBox="0 0 14 16" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
