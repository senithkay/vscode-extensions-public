...
// import {Conditional, Expression} from "../../../models/definitions";
...
//         conditionExpressionComponent =
//             <ExpressionComponent model={conditionExpression} callBack={callBack} isRoot={false}/>;
...
//     }
//
//     const onClickOnExpression = (expModel: Expression, e: any) => {
//         e.stopPropagation()
//         callBack(getSuggestionsBasedOnExpressionKind(c.CONDITIONAL), expModel)
//     };
//
//     return (
//         <span>
...
//                 onClick={(e) => onClickOnExpression(conditionExpression, e)}
//             >
//                 {conditionExpressionComponent}
//             </button>
//             <span
...
//             <button
//                 className={overlayClasses.AppTemplateButton}
//                 onClick={(e) => onClickOnExpression(trueExpression, e)}
//             >
//                 {trueExpressionComponent}
//             </button>
//             <span
//                 className={`${overlayClasses.AppExpressionBlock} ${overlayClasses.AppExpressionBlockDisabled}`}
//             >
...
//             <button
//                 className={overlayClasses.AppTemplateButton}
//                 onClick={(e) => onClickOnExpression(falseExpression, e)}
//             >
//                 {falseExpressionComponent}
//             </button>
//         </span>
//     );
// }
