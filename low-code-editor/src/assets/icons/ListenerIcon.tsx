...
export default function ListenerIcon(props: ListenerIconProps) {
    return (
        <svg width="16px" height="16px" viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            ...
            <g id="listener-icon" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="listener-body" transform="translate(-114.000000, -152.000000)" fill={props.color ? props.color : "#40404B"} fill-rule="nonzero">
