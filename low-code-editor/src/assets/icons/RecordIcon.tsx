...
export default function RecordIcon(props: RecordIconProps) {
    return (
        <svg width="16px" height="16px" viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            <g id="record-icon" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="record-icon-body" transform="translate(-114.000000, -496.000000)" fill={props.color ? props.color : "#40404B"} fillRule="nonzero">
