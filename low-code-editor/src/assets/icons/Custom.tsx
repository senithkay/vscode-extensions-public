    ...
    return (
        <svg width="20" height="20" {...props}>
            <g id="Custom-icon" transform="translate(0 0)">
                ...
                <path className="svg-plus-option-icon"  id="Path-24" d="M12.472.605,7.32,5.757V8.68h2.923L15.4,3.528A2.067,2.067,0,1,0,12.472.605Zm1.821,1.2a.249.249,0,0,1-.04.3l-4.9,4.894H9.006V6.641L13.9,1.747a.25.25,0,0,1,.353,0Z" fill="#5567d5" />
            </g>
        </svg>
    )
}
