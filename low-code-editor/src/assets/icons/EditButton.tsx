...
export default function EditButton(props: any) {
    return (
        <svg id="edit-button" width="13px" height="13px" {...props}>
            <title>4572E724-8103-4694-AEB7-A2D5B6FEA7F0</title>
            <defs>
            ...
            <g id="edit" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="edit-icon-shape" transform="translate(-290.000000, -281.000000)">
                    <g id="edit-icon" transform="translate(290.000000, 281.604014)">
                        ...
                        <use id="Combined-Shape" fill="#36B475" fill-rule="nonzero" xlinkHref="#edit-btn"/>
                    </g>
                </g>
            </g>
        </svg>
