...
public type BWebSocketRPCHandler object {

    *JObject;

    public BWebSocketRPCHandlerT _BWebSocketRPCHandler = BWebSocketRPCHandlerT;
    ...
    public function onMessage(string arg0) {
    ...
    public function 'wait1() returns error? {
        error|() obj = org_wso2_choreo_workspace_langserver_BWebSocketRPCHandler_wait1(self.jObj);
        if (obj is error) {
...
#
# + arg0 - Web socket caller proxy.
# + return - The new `BWebSocketRPCHandler` object generated.
public function newBWebSocketRPCHandler1(WSCallerProxy arg0) returns BWebSocketRPCHandler {
...
function org_wso2_choreo_workspace_langserver_BWebSocketRPCHandler_newBWebSocketRPCHandler1(WSCallerProxy arg0) returns handle = @java:Constructor {
    ...
    paramTypes: ["org.ballerinalang.jvm.values.ObjectValue"]
} external;
...
function org_wso2_choreo_workspace_langserver_BWebSocketRPCHandler_wait1(handle receiver) returns error? = @java:Method {
    name: "wait",
    class: "org.wso2.choreo.workspace.langserver.BWebSocketRPCHandler",
    paramTypes: []
} external;
