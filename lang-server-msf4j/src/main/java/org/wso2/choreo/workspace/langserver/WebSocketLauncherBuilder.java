...
public class WebSocketLauncherBuilder<T> extends Launcher.Builder<T> {
	...
	public WebSocketLauncherBuilder<T> setConnection(WebSocketConnection connection) {
	...
	public Launcher<T> create() {
		...
		if (connection == null)
			throw new IllegalStateException("WebSocket Connection must be configured.");
	...
	protected RemoteEndpoint createRemoteEndpoint(MessageJsonHandler jsonHandler) {
		MessageConsumer outgoingMessageStream = new WebSocketMessageConsumer(connection, jsonHandler);
