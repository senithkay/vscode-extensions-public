...
import { SelectionState, StatementEditorInfo, ViewOption } from "../../components/DataMapper/DataMapper";
...
export interface IDataMapperContext {
    ...
    enableStamentEditor: (statementEditorInfo: StatementEditorInfo) => void;
}
...
export class DataMapperContext implements IDataMapperContext {
    ...
    constructor(
        ...
        public enableStamentEditor: (statementEditorInfo: StatementEditorInfo) => void
    ){}
