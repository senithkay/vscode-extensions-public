...
export default function LabelTryIcon(props: any) {
    ...
    return (
        <svg id="try-button" width="13px" height="13px" onClick={handleOnClick} {...restProps} >
            <defs>
            ...
            <g id="try" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="try-icon-shape" transform="translate(-901.000000, -34.000000)">
                    <g id="try-icon" transform="translate(803.000000, 20.000000)">
                        <g id="try-icon-group" transform="translate(96.000000, 6.000000)">
                            <g id="try-icon-mask" transform="translate(2.450000, 8.616337)">
                                <mask id="mask-2" fill="white">
                                    <use xlinkHref="#try-btn" />
                                </mask>
                                <use id="Combined-Shape" fill="#40404B" fill-rule="nonzero" xlinkHref="#try-btn" />
                            </g>
                        </g>
                    </g>
                </g>
