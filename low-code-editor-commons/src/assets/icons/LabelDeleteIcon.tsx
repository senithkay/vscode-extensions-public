...
export default function LabelDeleteIcon(props: any) {
    ...
    return (
        <svg id="delete-button" width="13px" height="13px" onClick={handleOnClick} {...restProps} >
            <defs>
            ...
            <g id="Home" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="VSC-service-design-separrated-" transform="translate(-1069.000000, -32.000000)">
                    <g id="Group-6" transform="translate(803.000000, 20.000000)">
                        <g id="Group" transform="translate(265.000000, 6.000000)">
                            <g id="Icon/docs-Copy-7" transform="translate(1.500000, 6.000000)">
                                <mask id="mask-2" fill="white">
                                    <use xlinkHref="#path-1" />
                                </mask>
                                <use id="Combined-Shape" fill="#FE523C" fill-rule="nonzero" xlinkHref="#path-1" />
                            </g>
                        </g>
                    </g>
                </g>
