...
export const UserDetails = () => {
    ...
    return (React.createElement(Container, null,
        loginStatusPending && React.createElement(ProgressIndicator, null),
        React.createElement(UserInfo, null),
        currentProjectOrg && choreoProject && (React.createElement(React.Fragment, null,
            React.createElement(Seperator, null),
            React.createElement(ProjectDetails, null))),
        React.createElement(Seperator, null),
        React.createElement(VSCodeButton, { style: { width: '100%' }, appearance: "icon", onClick: openWalkthrough, title: "Open Choreo Walkthrough" },
            React.createElement(Codicon, { name: "info" }),
            React.createElement(IconLabel, null, "Feature Walkthrough"))));
};
