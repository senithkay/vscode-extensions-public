...
export const ComponentSyncAlert = () => {
    ...
    return (React.createElement(React.Fragment, null, !isLoadingComponents && componentsOutOfSync && (React.createElement(AlertBox, { subTitle: `Some components have pending changes that haven't been pushed to your remote Git repository.`, buttonTitle: "Open Source Control", iconName: "source-control", variant: "secondary", onClick: handleSourceControlClick }))));
};
//# sourceMappingURL=ComponentSyncAlert.js.map