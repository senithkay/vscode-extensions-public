    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Container, null,
            React.createElement(Body, null,
                (components === null || components === void 0 ? void 0 : components.length) > 0 && (React.createElement(React.Fragment, null,
                    React.createElement(ArchiViewButton, null),
                    React.createElement(CellViewButton, null))),
                React.createElement(OpenConsoleButton, null))),
        React.createElement(ComponentsCard, null)));
};
//# sourceMappingURL=ProjectActionsCard.js.map