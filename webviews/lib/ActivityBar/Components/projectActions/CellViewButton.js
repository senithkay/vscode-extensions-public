...
export const CellViewButton = () => {
    ...
    const handleClick = () => {
        ChoreoWebViewAPI.getInstance().sendTelemetryEvent({
            ...
            properties: {
                project: choreoProject === null || choreoProject === void 0 ? void 0 : choreoProject.name
            }
        });
        ChoreoWebViewAPI.getInstance().openCellView();
    };
    return (React.createElement(ProjectActionButton, { onClick: handleClick, label: "Cell View", icon: React.createElement(CellViewIcon, null), tooltip: "Open Cell View" }));
};
//# sourceMappingURL=CellViewButton.js.map