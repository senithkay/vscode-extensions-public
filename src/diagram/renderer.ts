...
export const BLCEDITOR_CDN = `https://choreo-shared-codeserver-cdne.azureedge.net/ballerina-low-code-editor-distribution@${process.env.BALLERINA_LOW_CODE_EDITOR_VERSION}`;
