...
export const CHOREO_API_PF = process.env.VSCODE_CHOREO_GATEWAY_BASE_URI ? process.env.VSCODE_CHOREO_GATEWAY_BASE_URI +
    "/performance-analyzer/2.0.0/get_estimations/3.0" :
